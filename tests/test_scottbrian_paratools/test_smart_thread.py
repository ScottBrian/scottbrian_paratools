...
class TestSmartThreadBasic:
    ...
    def test_smart_thread_basic_scenario3(self):
        ...
        alpha_smart_thread.send_msg(msg='hi beta, this is alpha', remote='beta', log_msg='ml send_msg 7')
        alpha_smart_thread.send_msg(msg='hi charlie, this is alpha', remote='charlie', log_msg='ml send_msg 8')
