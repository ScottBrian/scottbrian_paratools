...
class TestSmartThreadBasic:
    ...
    def test_smart_thread_basic_scenario1(self):
        ...
        def f1():
            ...
            assert beta_smart_thread.sync(target_set='alpha', log_msg='f1 sync 2')
            beta_smart_thread.send_msg(msg='hi alpha, this is beta', target_set='alpha', log_msg='f1 send_msg 3')
            assert beta_smart_thread.recv_msg(remote='alpha', log_msg='f1 recv_msg 4') == 'hi beta, this is alpha'
            assert beta_smart_thread.resume(target_set='alpha', log_msg='f1 resume 5')
        ...
        assert alpha_smart_thread.resume(target_set='beta', log_msg='ml resume 1')
        assert alpha_smart_thread.sync(target_set='beta', log_msg='ml sync 2')
        assert alpha_smart_thread.recv_msg(remote='beta', log_msg='ml recv_msg 3') == 'hi alpha, this is beta'
        alpha_smart_thread.send_msg(msg='hi beta, this is alpha', target_set='beta', log_msg='ml send_msg 4')
        assert alpha_smart_thread.wait(remote='beta', log_msg='f1 resume 5')
        # alpha_smart_thread.join(target_set='beta', log_msg='ml join 6')
    ...
    def test_smart_thread_basic_scenario2(self):
        ...
        def f1():
            ...
            assert beta_smart_thread.wait(remote='charlie', log_msg='f1 wait 6')
            assert beta_smart_thread.sync(target_set='charlie', log_msg='f1 sync 7')
            beta_smart_thread.send_msg(msg='hi charlie, this is beta', target_set='charlie', log_msg='f1 send_msg 8')
            assert beta_smart_thread.recv_msg(remote='charlie', log_msg='f1 recv_msg 9') == 'hi beta, this is charlie'
            assert beta_smart_thread.resume(target_set='charlie', log_msg='f1 resume 10')
        ...
        def f2():
            ...
            assert charlie_smart_thread.sync(target_set='alpha', log_msg='f2 sync 2')
            charlie_smart_thread.send_msg(msg='hi alpha, this is charlie', target_set='alpha', log_msg='f2 send_msg 3')
            assert charlie_smart_thread.recv_msg(remote='alpha', log_msg='f2 recv_msg 4') == 'hi charlie, this is alpha'
            assert charlie_smart_thread.resume(target_set='alpha', log_msg='f2 resume 5')

            assert charlie_smart_thread.resume(target_set='beta', log_msg='f2 resume 6')
            assert charlie_smart_thread.sync(target_set='beta', log_msg='f2 sync 7')
            assert charlie_smart_thread.recv_msg(remote='beta', log_msg='f2 recv_msg 9') == 'hi charlie, this is beta'
            charlie_smart_thread.send_msg(msg='hi beta, this is charlie', target_set='beta', log_msg='f2 send_msg 8')
            assert charlie_smart_thread.wait(remote='beta', log_msg='f2 wait 10')
        ...
        assert alpha_smart_thread.resume(target_set='charlie', log_msg='ml resume 6')
        assert alpha_smart_thread.sync(target_set='charlie', log_msg='ml sync 7')
        assert alpha_smart_thread.recv_msg(remote='charlie', log_msg='ml recv_msg 8') == 'hi alpha, this is charlie'
        alpha_smart_thread.send_msg(msg='hi charlie, this is alpha', target_set='charlie', log_msg='ml send_msg 9')
        assert alpha_smart_thread.wait(remote='charlie', log_msg='f1 resume 10')

        alpha_smart_thread.join(target_set='beta', log_msg='ml join 11')
        alpha_smart_thread.join(target_set='charlie', log_msg='ml join 12')
    ...
    def test_smart_thread_basic_scenario3(self):
        ...
        def f1():
            ...
            beta_smart_thread.send_msg(msg='hi alpha, this is beta', target_set='alpha', log_msg='f1 send_msg 3')
            assert beta_smart_thread.recv_msg(remote='alpha', log_msg='f1 recv_msg 4') == 'hi beta, this is alpha'
            beta_smart_thread.resume(target_set='alpha', log_msg='f1 resume 5')
        ...
        def f2():
            ...
            charlie_smart_thread.send_msg(msg='hi alpha, this is charlie', target_set='alpha', log_msg='f2 send_msg 3')
            assert charlie_smart_thread.recv_msg(remote='alpha', log_msg='f2 recv_msg 4') == 'hi charlie, this is alpha'
            charlie_smart_thread.resume(target_set='alpha', log_msg='f2 resume 5')
        ...
        assert alpha_smart_thread.resume(target_set='beta', log_msg='ml resume 1')
        assert alpha_smart_thread.resume(target_set='charlie', log_msg='ml resume 2')
        assert alpha_smart_thread.sync(target_set='beta', log_msg='ml sync 3')
        assert alpha_smart_thread.sync(target_set='charlie', log_msg='ml sync 4')
        ...
        alpha_smart_thread.send_msg(msg='hi beta, this is alpha', target_set='beta', log_msg='ml send_msg 7')
        alpha_smart_thread.send_msg(msg='hi charlie, this is alpha', target_set='charlie', log_msg='ml send_msg 8')
    ...
    def test_smart_thread_basic_scenario4(self):
        ...
        def f1():
            ...
            assert beta_smart_thread.wait(remote='alpha', log_msg='f1 wait 1')
            assert beta_smart_thread.sync(target_set={'alpha', 'charlie'}, log_msg='f1 sync 2')
            beta_smart_thread.send_msg(msg='hi alpha and charlie, this is beta', target_set={'alpha', 'charlie'},
            ...
            beta_smart_thread.resume(target_set={'alpha', 'charlie'}, log_msg='f1 resume 6')
        ...
        def f2():
            ...
            assert charlie_smart_thread.wait(remote='alpha', log_msg='f2 wait 1')
            assert charlie_smart_thread.sync(target_set={'alpha', 'beta'}, log_msg='f2 sync 2')
            charlie_smart_thread.send_msg(msg='hi alpha and beta, this is charlie', target_set={'alpha', 'beta'},
            ...
            charlie_smart_thread.resume(target_set={'alpha', 'beta'}, log_msg='f2 resume 7')
        ...
        assert alpha_smart_thread.resume(target_set={'beta', 'charlie'}, log_msg='ml resume 1')
        assert alpha_smart_thread.sync(target_set={'beta', 'charlie'}, log_msg='ml sync 2')
        ...
        alpha_smart_thread.send_msg(msg='hi beta and charlie, this is alpha', target_set={'beta', 'charlie'},
        ...
        alpha_smart_thread.join(target_set={'beta', 'charlie'}, log_msg='ml join 8')
